...
function Kitchnss() {
  return (
    <div>
      ...
      >
        <Link to="/">Home</Link>-<Link to="/Departments">Departments</Link>-<Link to="/Electrics">Electrical</Link>-Electric
        Products
      </div>
                  ...
                  >
                    <div className="accordion-body">
                      <ul>
                        ...
                        <li style={{ listStyle: "none" }}>
                          <Link to="/Bouquets"> Electric Fan</Link>
                        </li>
                        <li style={{ listStyle: "none" }}>
                          <Link to="/Bouquets"> E Heater</Link>
                        </li>
                        <li style={{ listStyle: "none" }}>
                          <Link to="/Bouquets"> RIce Cooker</Link>
                        </li>
