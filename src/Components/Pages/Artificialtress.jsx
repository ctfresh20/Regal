...
import ab from "../Products/2.jpeg";
import ac from "../Products/3.jpeg";
import ad from "../Products/4.jpeg";
import ae from "../Products/5.jpeg";
import af from "../Products/6.jpeg";
import ag from "../Products/7.jpeg";
import ah from "../Products/8.jpg";
import ai from "../Products/9.jpg";
import aj from "../Products/10.jpeg";
import ak from "../Products/11.jpg";
import al from "../Products/12.jpg";

function Artificialtress() {
  ...
  return (
    <div className="container-fluid">
      ...
      >
        <Link to="/">Home</Link>-<Link to="/Departments">Departments</Link>-<Link to="/Artificial">Artificial</Link>-Artificial
        Trees
      </div>
...
export default Artificialtress;
