...
function Incensedis() {
  ...
  return (
    <div className="container-fluid">
      ...
      >
        <Link to="/">Home</Link>-<Link to="/Departments">Departments</Link>-<Link to="/Incense">Incense</Link>- Incense Material
