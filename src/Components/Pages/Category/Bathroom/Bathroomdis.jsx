...
function Bathroomdis() {
  ...
  return (
    <div className="container-fluid">
      ...
      >
        <Link to="/">Home</Link>-<Link to="/Departments">Departments</Link>-<Link to="/Bathwares">Bathroom</Link>-Bathroom
        Products
      </div>
                    ...
                    <div className="accordion-body">
                      <ul>
                        <li style={{ listStyle: "none" }}>
                          <Link to="/Bath mats"> Bath Mats</Link>
                        </li>
                        <li style={{ listStyle: "none" }}>
                          <Link to="/Bouquets"> Bathroom Accessories</Link>
                        </li>
                        <li style={{ listStyle: "none" }}>
                          <Link to="/Bouquets"> Bathroom Scales</Link>
                        </li>
                        <li style={{ listStyle: "none" }}>
