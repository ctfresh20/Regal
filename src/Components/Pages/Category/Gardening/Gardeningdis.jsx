...
function Gardeningdis() {
  ...
  return (
    <div className="container-fluid">
      ...
      >
        <Link to="/">Home</Link>-<Link to="/Departments">Departments</Link>-<Link to="/Gardening">Gardening</Link>- Gardening Material
