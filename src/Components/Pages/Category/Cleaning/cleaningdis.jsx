...
function Cleaningdis() {
  ...
  return (
    <div className="container-fluid">
      ...
      >
        <Link to="/">Home</Link>-<Link to="/Departments">Departments</Link>-<Link to="/Cleaning">Cleaning</Link>-Cleaning 
        Material
