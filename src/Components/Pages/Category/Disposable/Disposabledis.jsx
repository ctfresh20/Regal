...
function Disposabledis() {
  ...
  return (
    <div className="container-fluid">
      ...
      >
        <Link to="/">Home</Link>-<Link to="/Departments">Departments</Link>-<Link to="/Disposable">Disposable</Link>-Disposable 
        Material
