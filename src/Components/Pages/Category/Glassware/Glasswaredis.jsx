...
function Glasswaredis() {
  ...
  return (
    <div className="container-fluid">
      ...
      >
        <Link to="/">Home</Link>-<Link to="/Departments">Departments</Link>-<Link to="/Glassware">Glassware</Link>- Glassware Material
...
LOGIN TO SEE TRADE PRICES
                    ...
                    </div>                   <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" style={{marginTop:"3%"}}>
<Link to="/anything">
    <img src={aj} style={{width:"100%"}} />
    <div style={{marginTop:"3%"}} className="container text-center" >
    <Link to="/" style={{textDecoration:"none", color:"black"}}>
   Tools & Accessories</Link>
    </div>
</Link>
    <div className="container-fluid btn btn-primary" style={{marginTop:"3%"}}>
LOGIN TO SEE TRADE PRICES
